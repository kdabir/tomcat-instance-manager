...
rem author : kunal
rem last-edit : 15 Nov 2014
rem based on patch : https://code.google.com/p/tomcat-instance-manager/issues/detail?id=1
rem ============================================================================
...
if not exist "%CATALINA_HOME%\bin\tomcat8.exe" goto home-not-valid
if not exist "%CATALINA_HOME%\bin\tomcat8w.exe" goto home-not-valid
...
set TOMCATEXE=%CATALINA_HOME%\bin\tomcat8.exe
set TOMCAT_SVC_MGR=%CATALINA_HOME%\bin\tomcat8w.exe
